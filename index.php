...
<body>
  ...
  <div class="entry">
    <div class="title big <?php if($row['sponsoredJob'] == 1) { echo "talon"; } ?>"><?php if($row['sponsoredJob'] == 1) : ?><img width="15%" src="assets/img/talon.png"/><?php endif; ?><?php echo $row['crime'] ?></div>
    <div class="body">
